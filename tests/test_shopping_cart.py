...
def test_complex_checkout():
    ...
    assert receipt.total == 1 * pricing_model.policy["pack-of-6-eggs"].amount + 6 * pricing_model.policy["bottle-of-milk"].amount +  3 * pricing_model.policy["pack-of-sugar"].amount